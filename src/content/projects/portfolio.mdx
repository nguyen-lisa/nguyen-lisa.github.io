...
- **Accessibility:** Designed to conform to **WCAG 2.0 Level AA (AODA)**; skip link, keyboard-friendly TOC, reduced-motion support  
- **Timeline:** 2 weeks (see breakdown below)  
- **Links:** [Résumé](/resume.pdf) · [Figma Prototype](https://www.figma.com/proto/ev3JHCYyJgBYDc1gCM5ARH/Portfolio?node-id=0-1&t=DGX0Ilqi9XBD2rzU-1)
...
This site is designed to conform to **WCAG 2.0 Level AA (AODA)** and additionally checked against key **WCAG 2.1/2.2** criteria (keyboard operation, focus visibility, reduced motion). I verified contrast with **Colour Contrast Analyser** and audited pages with **axe DevTools**; all interactive paths support keyboard use and include a **Skip to content** link.
