...
- axe DevTools (Free) on Home + Case Study: **0 critical** violations (date: 2025-09-07)
  ...
  <ImageGrid
    images={[
      { src: "/images/portfolio/axeHomeAudit.png",  alt: "Lighthouse Mobile summary. Emulated form factor: mobile.",  caption: "Lighthouse — Mobile (Emulated form factor: mobile) — 2025-09-07" },
      { src: "/images/portfolio/axeCaseAudit.png", alt: "Lighthouse Desktop summary. Emulated form factor: desktop.", caption: "Lighthouse — Desktop (Emulated form factor: desktop) — 2025-09-07" }
    ]}
  />
</details>
