...
> **Tech highlights**
> - Next.js App Router, static export for GitHub Pages (basePath/assetPrefix tuned)
> - MDX + Contentlayer (typed `Project` model, front-matter → routes)
> - Sticky left TOC (IntersectionObserver, offset-aware smooth scroll)
> - Accessible lightbox (Esc/←/→, focus trap, restore focus)
> - Tailwind v4 tokens + component classes (btn variants, high-contrast theme)
> - ESLint + `jsx-a11y`; Lighthouse/axe audits clean
...
- **Links:** <a href="/LisaNguyenResume.pdf" target="_blank" rel="noreferrer">Resume</a> · [Figma Prototype](https://www.figma.com/proto/ev3JHCYyJgBYDc1gCM5ARH/Portfolio?node-id=0-1&t=DGX0Ilqi9XBD2rzU-1)
