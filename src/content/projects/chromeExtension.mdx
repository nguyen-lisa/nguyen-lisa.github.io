---
title: "Breadcrumbs - Pending Chrome Extension"
...
<ImageGrid
  images={[
    {
      src: "/images/chromeExt/darkEmpty.png",
      alt: "Breadcrumbs extension dashboard in dark mode with an empty Saved Highlights list and action buttons",
      caption: "Dark mode — empty state"
    },
    {
      src: "/images/chromeExt/darkFull.png",
      alt: "Breadcrumbs extension dashboard in dark mode showing saved highlights in the Saved Highlights list with action buttons",
      caption: "Dark mode — highlights saved"
    },
    {
      src: "/images/chromeExt/lightEmpty.png",
      alt: "Breadcrumbs extension dashboard in light mode with an empty Saved Highlights list and action buttons",
      caption: "Light mode — empty state"
    },
    {
      src: "/images/chromeExt/lightFull.png",
      alt: "Breadcrumbs extension dashboard in light mode showing saved highlights in the Saved Highlights list with action buttons",
      caption: "Light mode — highlights saved"
    }
  ]}
/>
