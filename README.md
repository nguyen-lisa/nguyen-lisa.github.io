...
Fast, accessibility-first portfolio built with **Next.js (App Router)**, **TypeScript**, **MDX + Contentlayer**, and **Tailwind**. Designed to help recruiters review my work quickly with clear paths to Resume, Featured Projects, and Case Studies.
...
- Featured-first layout (high-signal projects up front)
- About/Resume section with quick access from main navigation
- MDX notes/blog powered by Contentlayer
- Responsive, accessible UI (keyboard-first navigation, visible focus states, semantic landmarks)
- SEO-friendly metadata & social previews
- Optional UI components used across case studies (e.g., sticky TOC, lightbox/gallery patterns if present)

---

## Tech Stack
- **Framework:** Next.js (App Router; create-next-app) + **static export** for GitHub Pages
- **Language:** TypeScript
- **Content:** MDX via Contentlayer (typed content + frontmatter-driven pages)
- **Styling:** Tailwind CSS
- **Tooling:** ESLint (including `eslint-plugin-jsx-a11y`)
- **Hosting:** GitHub Pages
- **CI/CD:** GitHub Actions (build + export + deploy on push to `main`)
